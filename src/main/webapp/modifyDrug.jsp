                    ...
                    <div class="col-sm-12">
						<span class="ibox float-e-margins" style="text-align: center">
							<div class="ibox-title" align="center">
								...
								<br>
								<center>
									<form name="f" action="modifyDrug.do" method="post"
										...
										<table style="text-align: center;line-height: 60px;width: 100%">
											...
											<tr>
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" name="unit" value="${drug.unit}">
												</div>
												</td>
											</tr>
											<tr>
												<td>
													...
													<div class="col-sm-10">
													<input type="text" class="form-control" name="packageType" value="${drug.packageType}">
												</div>
												</td>
											</tr>
										</table>
